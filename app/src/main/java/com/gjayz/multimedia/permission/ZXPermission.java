package com.gjayz.multimedia.permission;
...
public class ZXPermission {
    ...
    private static final String TAG = "ZXPermission";
     ...
     */
    @RequiresApi(api = Build.VERSION_CODES.M)
    public static boolean shouldShowRequestPermissionRationale(Activity activity, String
            permissions) {
        return activity.shouldShowRequestPermissionRationale(permissions);
    }

    @RequiresApi(api = Build.VERSION_CODES.M)
    public static void askForPermission(Activity activity, String
    ...
    @RequiresApi(api = Build.VERSION_CODES.M)
    public static void askForPermission(Activity activity, String[]
            permissions, PermissionCallback permissionCallback) {
